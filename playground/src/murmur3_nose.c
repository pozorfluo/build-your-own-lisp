 ...
 */
uint32_t
murmurhash3_x86_32(const void *key, const size_t len, const uint32_t seed)
{
 ...
 */
Hash128
murmurhash3_x86_128(const void *key, const size_t len, const uint32_t seed)
{
